...
from savvy import collection, top_global_groups_collection, group_user_totals_collection, user_collection, user_totals_collection, savvyy
from savvy import application, PHOTO_URL, SUPPORT_CHAT, UPDATE_CHAT, BOT_USERNAME, db, GROUP_ID, LOGGER
from savvy import pm_users as collection 
from savvy.modules import ALL_MODULES
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("savvy.modules." + module_name)
...
***🍂 ɢʀᴇᴇᴛɪɴɢs, ɪ'ᴍ ˹ʜᴜsʙᴀɴᴅᴏ ɢꝛᴀʙʙᴇꝛ ʙᴏᴛ˼ 🥤, ɴɪᴄᴇ ᴛᴏ ᴍᴇᴇᴛ ʏᴏᴜ!
━━━━━━━▧▣▧━━━━━━━
⦾ ᴡʜᴀᴛ ɪ ᴅᴏ: ɪ sᴘᴀᴡɴ   
     ʜᴜsʙᴀɴᴅᴏs ɪɴ ʏᴏᴜʀ ᴄʜᴀᴛ ғᴏʀ
     ᴜsᴇʀs ᴛᴏ ɢʀᴀʙ.
...
━━━━━━━▧▣▧━━━━━━━***
        ...
        keyboard = [
            ...
            [inlineKeyboardButton("OWNER    url=f'https://t.me/ranavanshi_divy')],
        ]
