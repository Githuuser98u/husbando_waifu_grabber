...
from savvy import application, sudo_users, collection, db, CHARA_CHANNEL_ID, SUPPORT_CHAT
...
rarity_map = 1 (🍃 Common), 2 (☘️ Rare) , 3 (🍀 Legendary), 4 (🌿 Medium)"""
...
async def update(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        if args[1] in ['name', 'anime']:
            ...
            rarity_map = {1: "🍃 Common", 2: "☘️ Rare", 3: "🍀 Legendary", 4: "🌿 Medium", 5: "🍁 Special edition"}
            try:
