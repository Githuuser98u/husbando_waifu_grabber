...
from savvy import user_collection, savvyy

pending_trades = {}


@savvyy.on_message(filters.command("trade"))
...
@savvyy.on_callback_query(filters.create(lambda _, __, query: query.data in ["confirm_trade", "cancel_trade"]))
...
@savvyy.on_message(filters.command("gift"))
...
@savvyy.on_callback_query(filters.create(lambda _, __, query: query.data in ["confirm_gift", "cancel_gift"]))
async def on_callback_query(client, callback_query):
